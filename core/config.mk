...
ifeq (,$(strip $(BOARD_CUSTOM_BOOTCONFIG)))
BOOTCONFIG := prebuilts/evervolv-tools/$(BUILD_OS)-$(HOST_PREBUILT_ARCH)/bin/bootconfig
else
BOOTCONFIG := $(BOARD_CUSTOM_BOOTCONFIG)
endif
...
ifneq (,$(wildcard device/evervolv/sepolicy/common/sepolicy.mk))
$(eval include device/evervolv/sepolicy/common/sepolicy.mk)
endif
